...
@NgModule({
  ...
  imports: [BrowserModule, HttpClientModule], // Import modules that this module needs
  ...
  bootstrap: [AppComponent], // Bootstrap component that will be loaded when the app starts
})
